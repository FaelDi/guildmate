...
export const ptBR = {
  ...
  vx: {
    ...
    signedUp: 'Cadastro enviado! Assim que um admin aprovar, você já pode entrar.',
    approvalsTitle: '📝 Cadastros aguardando aprovação',
    approvalsHint: 'Ninguém entra sozinho: aprove só quem joga na guild.',
    approvalsEmpty: 'Nenhum cadastro na fila.',
    approvalsHead: {
      character: 'Personagem',
      account: 'Conta',
      since: 'Cadastrou em',
    ...
    createGuildTitle: '🏰 Criar outra guild',
    createGuildHint:
      'O site é da guild principal, mas o super admin pode hospedar outras. A nova guild nasce vazia e com um link de líder de uso único.',
    guildName: 'Nome da guild:',
    guildTag: 'Tag (opcional):',
    guildNote: 'Anotação (para quem é o link):',
    createGuild: 'Criar guild e gerar link de líder',
    leaderLinkOnce: 'Copie agora — o link de líder aparece uma única vez',
    expires: 'Expira',
    guildsTitle: 'Guilds neste servidor',
    guildsHint: 'A principal é a dona do site: é o painel que aparece para quem não está logado.',
    guildsHead: ['Guild', 'Endereço', 'Situação', 'Criada em'],
    primaryGuild: 'principal',
    ...
    bet: '🎲 Apostar',
    signInToBet: 'Entrar para apostar',
    restrictedCell: 'Faça login como membro para visualizar',
    restricted: '🔒 Restrito',
    removeBet: 'Remover',
  ...
  errors: {
    ...
    ACCOUNT_PENDING_APPROVAL:
      'Sua conta ainda não foi aprovada por um admin da guild. Assim que aprovarem, você entra normalmente.',
    SELF_APPROVAL_FORBIDDEN: 'Você não pode aprovar a sua própria conta',
    ALREADY_APPROVED: 'Esta conta já foi aprovada',
    INVALID_GUILD_NAME: 'O nome da guild precisa ter entre 2 e 60 caracteres',
    INVALID_GUILD_TAG: 'A tag pode ter no máximo 8 caracteres',
